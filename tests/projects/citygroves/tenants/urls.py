...
urlpatterns = [
    ...
    path(
        r"applications/<int:pk>/getlease/",
        views.GetApplicationLease.as_view(),
        name="application-getlease",
    ),
    path(
        r"entry-notices/<int:pk>/send/",
        views.EntryNoticeSend.as_view(),
        name="entry-notices-send",
    ),
]
